...
import android.os.Environment;//Importamos para que pueda acceder a nuestra memoria externa del celular
...
public class MainActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    //Creamos un condicional si es que se activo YOLO
    ...
    public void YOLO(View Button){
        ...
        if (startYolo == false){
            ...
            if (firstTimeYolo == false){
                ...
                firstTimeYolo = true;
                //Indicamos la ruta de la carpeta de los genomas: "/dnns/yolov3-tiny.cfg"
    ...
    //Se modifico el metodo de abajo para que cargue cuando se inicia la camara
    @Override
